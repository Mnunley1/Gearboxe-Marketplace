...
export function EventCard({ event, showRegister = true }: EventCardProps) {
  ...
  return (
    <Card className="group overflow-hidden border-gray-200/60 bg-white transition-all duration-300 hover:border-gray-300/80 hover:shadow-gray-200/50 hover:shadow-xl">
        ...
        <div className="flex flex-col sm:flex-row">
          ...
          <div className="relative flex flex-shrink-0 items-center justify-center bg-gradient-to-br from-primary to-primary/90 p-6 text-white sm:w-32">
            <div className="text-center">
              <div className="font-medium text-sm uppercase tracking-wider opacity-90">
                {dayOfWeek}
              </div>
              <div className="font-bold text-4xl leading-none">
                {new Date(event.date).getDate()}
              </div>
              <div className="mt-1 font-medium text-sm uppercase tracking-wider opacity-90">
            ...
            {isUpcoming && daysUntil <= 7 && (
              <div className="absolute top-2 right-2 rounded-full bg-white/20 px-2 py-0.5 font-bold text-[10px] uppercase tracking-wide">
      ...
      <CardFooter className="flex gap-3 border-gray-100 border-t bg-gray-50/50 p-4">
